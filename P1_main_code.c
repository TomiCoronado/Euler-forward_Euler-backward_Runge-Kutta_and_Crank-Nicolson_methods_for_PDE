...
One can see the numerical damping effect of the implicit method
compared to the numerical instability of the explicit method (solution ->
infinity with t -> infinity).
*/
